...
HD_PWD='D:/coding/vivado/CNotion/CNotion.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log nexys_ddr_top.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source nexys_ddr_top.tcl -notrace
