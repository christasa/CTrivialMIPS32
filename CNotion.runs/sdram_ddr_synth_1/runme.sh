...
HD_PWD='D:/coding/vivado/CNotion/CNotion.runs/sdram_ddr_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log sdram_ddr.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source sdram_ddr.tcl
