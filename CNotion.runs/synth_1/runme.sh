...
HD_PWD='D:/coding/vivado/CNotion/CNotion.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log nexys_ddr_top.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source nexys_ddr_top.tcl
