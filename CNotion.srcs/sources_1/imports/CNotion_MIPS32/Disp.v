...
input clk; // 时钟显示
input [7:0] number; //显示的数�?

output reg[7:0] sseg_an; // 低位数码�?
output reg [7:0] sseg_ca; // 高位数码�?;
